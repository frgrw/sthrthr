...
*/
  ...
  [1] = LAYOUT( \
    _______, _______, _______, _______, _______, KC_WWW_SEARCH, KC_WWW_REFRESH, _______, _______, KC_MEDIA_PLAY_PAUSE, KC_MUTE, KC_VOLD, KC_VOLU, RESET, _______, _______, \
