...
*/
  ...
  [0] = LAYOUT( \
    KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,     KC_F12,  KC_PRINT_SCREEN, KC_SCROLL_LOCK, KC_PAUSE, MO(1), \
  ...
  [1] = LAYOUT( \
    _______, _______, _______, _______, _______, KC_WWW_SEARCH, KC_WWW_REFRESH, _______, _______, KC_MEDIA_PLAY_PAUSE, KC_MUTE, KC_VOLD, KC_VOLU, QK_BOOTLOADER, _______, _______, \
